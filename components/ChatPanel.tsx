...
/* The chat panel proper. Split out of ChatWidget and loaded on demand: the AI
   SDK and the Markdown renderer are the two heaviest client dependencies on the
   site, and most visitors never open the chat, so they should not be in the
   bundle every page ships. ChatWidget renders only the bubble and imports this
  ...
  return (
    <div className="chat-panel" role="dialog" aria-label="Chat with Earth Link">
      ...
      <div className="chat-foot">
        <a className="chat-foot-btn" href={WHATSAPP_HREF} target="_blank" rel="noopener noreferrer">
          WhatsApp
        </a>
