...
const socials = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/earthlinkdubai/',
  ...
  {
    label: 'X',
    href: 'https://x.com/Earthlinkdubai',
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/earthlinkrealestatellc',
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/82621395/',
  ...
  {
    label: 'YouTube',
    href: 'https://www.youtube.com/@earthlinkrealestate',
