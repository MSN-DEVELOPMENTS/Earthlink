...
export const developers: Developer[] = [
  ...
  },
  {
    ...
    image: '/developers/samana.jpg',
    brochuresUrl: 'https://www.samanadevelopers.com/',
    projects: [
      {
        ...
        description: [
          ...
          'Residents enjoy a resort-style amenity deck including a main adult pool, kids\' pool and jacuzzi with sunken seating, plus indoor and outdoor gyms, an outdoor cinema, BBQ areas, a children\'s play area and a daycare centre. Positioned just off Sheikh Mohammed Bin Zayed Road and Ras Al Khor Road, the project sits roughly 15-18 minutes from Dubai International Airport and 20-25 minutes from Downtown Dubai, with flexible 1% monthly payment plans and handover scheduled for Q4 2028.',
        ],
        location: {
          area: 'Al Warsan, International City Phase 2, Dubai',
          nearby: ['Dubai Safari Park — 10 min', 'Expo City Dubai — 15 min', 'Dubai International Airport — 18 min', 'Downtown Dubai & Burj Khalifa — 22 min', 'Dubai Mall — 25 min', 'Dubai Marina — 30 min'],
        },
        unitTypes: '1 & 2-bedroom apartments (convertible layouts) plus retail',
        sizes: 'Approx. 650 – 950 sqft',
        bedrooms: '1 & 2 bed',
        amenities: ['Main adult swimming pool', 'Kids\' pool', 'Jacuzzi with sunken seating', 'Large leisure pool deck', 'Indoor gym', 'Outdoor gym', 'Outdoor cinema', 'BBQ area', 'Children\'s play area', 'Daycare centre', 'Multi-purpose room', 'Landscaped gardens', '24/7 security'],
        paymentPlan: '5% on booking, 5% after 1 month, 5% on 4th month, then 1% per month',
        handover: 'Q4 2028',
      },
      {
        ...
        community: 'Majan',
        price: 'From AED 749K',
        image: '/projects/samana-barari-views/hero.jpg',
        gallery: ['/projects/samana-barari-views/g1.jpg', '/projects/samana-barari-views/g2.jpg', '/projects/samana-barari-views/g3.jpg'],
        url: 'https://www.samanadevelopers.com/projects/samana-barari-views',
        tagline: 'Greenest Samana retreat with private-pool smart-home apartments.',
        description: [
        ...
        location: {
          area: 'Majan, Wadi Al Safa, Dubailand',
          nearby: ['IMG Worlds of Adventure — 6 min', 'Global Village — 9 min', 'Dubai Miracle Garden — 10 min', 'Dubai Hills Mall — 15 min', 'Dubai Outlet Mall — 15 min', 'Mall of the Emirates — 20 min', 'Downtown Dubai / Burj Khalifa — 25 min'],
        },
        unitTypes: 'Studios, 1, 2 & 3-bedroom apartments, all with private pools',
        sizes: 'Approx. 400 – 3,350 sqft',
        bedrooms: 'Studio to 3 bed',
        amenities: ['Private swimming pool in every unit', 'Smart home automation technology', 'Indoor and outdoor gymnasiums', 'Leisure pool deck and lazy river', 'Trampoline park', 'Basketball court', 'Table tennis court', 'Jogging track', 'Steam and sauna rooms', 'Kids\' pool and play area', 'VR golf facility', 'Cabana and barbecue area', 'Outdoor cinema', '24/7 security with CCTV'],
        paymentPlan: '20% down, 1% monthly during construction, plus post-handover instalments',
        handover: 'Q3 2027',
      },
      {
        ...
        community: 'Dubai Islands',
        price: 'From AED 2.5M',
        image: '/projects/samana-ocean-pearl/hero.jpg',
        gallery: ['/projects/samana-ocean-pearl/g1.jpg', '/projects/samana-ocean-pearl/g2.jpg', '/projects/samana-ocean-pearl/g3.jpg'],
        url: 'https://www.samanadevelopers.com/projects/samana-ocean-pearl',
        tagline: 'Beachfront waterfront living reimagined on exclusive Dubai Islands.',
        description: [
        ...
        location: {
          ...
          nearby: ['Dubai Canal — 5 min', 'Port Rashid — 10 min', 'Deira & Dubai Creek — 10-15 min', 'Al Mamzar Beach Park — 15-20 min', 'Dubai International Airport — 25 min'],
        },
        unitTypes: '1, 2, 3 & 4-bedroom apartments, many with private pools',
        sizes: 'On request',
        bedrooms: '1 to 4 bed',
        amenities: ['Large leisure pool deck & jacuzzi', 'Private pools in apartments', 'Kids\' pool & splash area', 'Outdoor cinema', 'Outdoor gym & running track', 'BBQ area', 'Steam & sauna', 'Sun deck & landscaped green spaces', 'Waterfall feature', 'Smart home technology', 'POD parking & bicycle parking'],
        paymentPlan: 'From 15-20% down, instalments during construction and post-handover',
        handover: 'Q4 2026',
      },
      {
        slug: 'samana-skyros',
        ...
        community: 'Arjan',
        price: 'From AED 792K',
        image: '/projects/samana-skyros/hero.jpg',
        gallery: ['/projects/samana-skyros/g1.jpg', '/projects/samana-skyros/g2.jpg', '/projects/samana-skyros/g3.jpg'],
        url: 'https://www.samanadevelopers.com/projects/samana-skyros',
        tagline: 'A 17-storey resort-style tower where every day feels like a holiday.',
        description: [
          ...
          'Residents enjoy a large leisure pool deck with cascading water features, private in-unit pools, a fully equipped fitness center, rooftop jogging park, sauna and steam rooms, outdoor cinema, kids\' play area and a rooftop basketball court. Positioned minutes from Dubai Miracle Garden, Dubai Sports City and Mall of the Emirates, Skyros combines strong connectivity with attractive, flexible payment plans and a 2026 handover.',
        ],
        location: {
          area: 'Arjan, Dubailand, Dubai',
          nearby: ['Dubai Miracle Garden — 5 min', 'Dubai Sports City — 10 min', 'Dubai Autodrome — 10 min', 'Dubai Hills Mall — 12 min', 'Mall of the Emirates — 15 min', 'IMG Worlds of Adventure — 15 min', 'Downtown Dubai / Burj Khalifa — 20 min'],
        },
        unitTypes: 'Studios, 1 & 2-bedroom apartments, most with private pools',
        sizes: 'Approx. 430 – 1,900 sqft',
        bedrooms: 'Studio to 2 bed',
        amenities: ['Large leisure pool deck with water features', 'Private pools in select apartments', 'State-of-the-art fitness center', 'Rooftop jogging park', 'Sauna & steam rooms', 'Outdoor cinema', 'Kids\' play area', 'Rooftop basketball court', 'Valet parking', 'Rooftop lounge'],
        paymentPlan: '15% on booking, balance during construction; extended plan post-handover',
        handover: 'Q2 2026',
      },
      {
        ...
        price: 'From AED 740K',
        image: '/projects/samana-manhattan-2/hero.jpg',
        gallery: ['/projects/samana-manhattan-2/g1.jpg', '/projects/samana-manhattan-2/g2.jpg', '/projects/samana-manhattan-2/g3.jpg'],
        url: 'https://www.samanadevelopers.com/projects/samana-manhattan-2',
        tagline: 'Luxury that looks outward, with panoramic JVC cityscape views.',
        description: [
        ...
        location: {
          ...
          nearby: ['Mall of the Emirates — 5-10 min', 'Dubai Sports City — 5-10 min', 'Motor City & Dubai Autodrome — 5-10 min', 'Dubai Marina — 10-15 min', 'Palm Jumeirah — 10-15 min', 'Business Bay — 10-15 min', 'Downtown Dubai & Burj Khalifa — 15-20 min'],
        },
        unitTypes: 'Studios, 1 & 2-bedroom apartments, select units with private pools',
        sizes: 'Approx. 452 – 1,345 sqft',
        bedrooms: 'Studio to 2 bed',
        amenities: ['Large leisure pool deck', 'Private pools in select apartments', 'Indoor and outdoor fitness centre', 'Rooftop jogging track', 'Rooftop basketball court', 'Outdoor cinema', 'Sauna and steam room', 'Kids\' play area', 'Valet parking and concierge services'],
        paymentPlan: '20% down, 1% monthly during construction, then post-handover instalments',
        handover: 'Q4 2026',
      },
    ],
  },
